...
if __name__ == '__main__':
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": """
            You will be given one or multiple chunk of text followed by a named entity belonging to one of the following classes : Location (LOC), Person (PER), Miscelaneous (MISC), Organization (ORG), None of the others (NONE)
